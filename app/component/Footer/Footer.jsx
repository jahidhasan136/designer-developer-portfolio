        ...
        <div className='text-white relative mt-[180px] md:mt-[280px] lg:mt-[393px] xl:mt-[493px]'>
            <div className='container absolute -top-24 lg:-top-1/3 left-0 right-0 inline-flex '>
                ...
                <div className='bg-[#F5FDFD] px-[20px] md:px-[120px] lg:px-[220px] py-[38px] md:py-[78px] lg:py-[98px] text-center rounded-lg md:rounded-[40px] mx-auto relative z-10'>
                    ...
                    <h1 className='text-black text-lg md:text-2xl lg:text-[32px] xl:text-[45px] font-bold mb-3 md:mb-6 lg:mb-[33px] xl:mb-[43px] lg:leading-[45px] xl:leading-[55px]'>Can't find your desire service? <br /> <span className='text-[#FF4F6E]'>Let us know 24/7 in 123456</span></h1>
                    <div className='flex gap-[25px] justify-center'>
                        <Link href='/' className='primary-btn text-sm md:text-base'>Hire Me</Link>
                        <Link href='/' className='bg-white px-7 py-3 border border-[#009DAE] rounded-[5px] text-[#009DAE] hover:text-white hover:bg-[#009DAE] transition-all text-sm md:text-base'>123456</Link>
                    </div>
                </div>
            </div>
